          ...
          <div className="flex flex-col gap-3">
            ...
            <span className="gap-1 flex flex-col">
              ...
              <span className="flex gap-1">
                ...
                <Link href={`https://www.google.com/maps/place/Plot+No+-+HIG+-+42+%2C+Jayadev+Vihar%2C+Bhubaneswar/@15.3527901,75.5659991,17z/data=!3m1!4b1!4m5!3m4!1s0x3b1a5b7b7b7b7b7b:0x3b1a5b7b7b7b7b7b!8m2!3d15.3527901!4d75.5681878`}>
